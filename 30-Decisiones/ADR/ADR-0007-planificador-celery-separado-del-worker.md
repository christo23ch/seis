...
- **La topología queda bajo test**, y el test ya no es una lista escrita a mano: `backend/tests/test_despliegue.py` **deriva del propio `docker-compose.yml` la expectativa que comprueba**. El fichero de despliegue deja de ser prosa que nadie verifica. **Cifra del bloque en su momento (histórica; la de cierre de la fase es 393 · 391 · 0 · 2): 220 recogidos · 217 pasan · 2 fallan · 1 omitido** — **+58 verdes y 0 regresiones** frente a la línea base de la fase (162 · 159 · 2 · 1); los 2 rojos siguen siendo los preexistentes de PDF. Las medidas intermedias (212 y 233) quedan derogadas.

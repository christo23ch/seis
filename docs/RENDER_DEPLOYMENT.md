...
curl https://seis-backend-XXXXX.onrender.com/health
# Debe devolver: {"status": "ok", "componentes": {"db": {"status": "ok"}, ...}}
...
2. GitHub Repository → **"Settings"** → **"Secrets and variables"** → **"Actions"**
   - Agregar secret: `RENDER_BACKEND_DEPLOY_HOOK_STAGING`
   - Agregar secret: `RENDER_BACKEND_DEPLOY_HOOK_PRODUCTION`
...
- [ ] Health check devuelve 200 con todos componentes ok
